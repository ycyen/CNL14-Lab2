...
if ($_GET['login'] == login) {
  ...
  $titel = 'Logging in to ACENET HotSpot'; 
  $headline = 'Logging in to ACENET HotSpot';
  $bodytext = ''; 
  print_header();
...
if ($_GET['res'] == success) {
  $result = 1;
  $titel = 'Logged in to ACENET HotSpot';
  $headline = 'Logged in to ACENET HotSpot';
  $bodytext = 'Welcome';
...
if ($_GET['res'] == logoff) {
  $result = 3;
  $titel = 'Logged out from ACENET HotSpot';
  $headline = 'Logged out from ACENET HotSpot';
...
if ($_GET['res'] == already) {
  $result = 4;
  $titel = 'Already logged in to ACENET HotSpot';
  $headline = 'Already logged in to ACENET HotSpot';
...
if ($_GET['res'] == popup1) {
  $result = 11;
  $titel = 'Logging into ACENET HotSpot';
